...
const BUNDLE_NAME = "03_the_tangle.standalone.jl"
const BUNDLE_URL = get(() -> "https://kahliburke.github.io/portfolio/03-the-tangle/03_the_tangle.standalone.jl", ENV, "SLATE_BUNDLE_URL")
